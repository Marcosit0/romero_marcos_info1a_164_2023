...
from APP_DEPENSE_164.erreurs.msg_erreurs import *
from APP_DEPENSE_164.erreurs.exceptions import *


@app.route('/index')
def index():
    return "Salut Maccaud, salut tout le monde ! je veux que vous compreniez que j'ai voulu partir sur une base de gestionnaire de dépense et j'aurais pas du... parce que ducoup tout change. C'est plus qu'un simple jeu de différence comme vous aimez le dire. Merci de votre compréhension."
