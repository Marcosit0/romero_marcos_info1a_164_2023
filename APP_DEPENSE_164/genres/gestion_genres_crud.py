        ...
        try:
            with DBconnection() as mc_afficher:
                if order_by == "ASC" and id_genre_sel == 0:
                    strsql_genres_afficher = """SELECT id_categorie, nom_categorie, date_ins_categorie
                                                FROM t_categorie"""
                ...
                if not data_genres and id_genre_sel == 0:
                    ...
                    flash(f"La catégorie demandé n'existe pas !!", "warning")
                else:
                    # Dans tous les autres cas, c'est que la table "t_genre" est vide.
                    # OM 2020.04.09 La ligne ci-dessous permet de donner un sentiment rassurant aux utilisateurs.
                    flash(f"Données catégorie affichés !!", "success")
    ...
    if request.method == "POST":
        try:
            if form.validate_on_submit():
                ...
                strsql_insert_genre = """INSERT INTO t_categorie (id_categorie,nom_categorie) VALUES (NULL,%(value_intitule_genre)s) """
...
"""
    ...
    Remarque :  Dans le champ "nom_genre_update_wtf" du formulaire "genres/personne_update_wtf.html",
                le contrôle de la saisie s'effectue ici en Python.
                On transforme la saisie en minuscules.
                On ne doit pas accepter des valeurs vides, des valeurs avec des chiffres,
                des valeurs avec des caractères qui ne sont pas des lettres.
...
def genre_update_wtf():
    ...
    try:
        ...
        if request.method == "POST" and form_update.submit.data:
            ...
            str_sql_id_genre = "SELECT id_categorie, nom_categorie, date_ins_categorie FROM t_categorie " \
            ...
            form_update.date_genre_wtf_essai.data = data_nom_genre["date_ins_categorie"]
...
"""
    ...
    Remarque :  Dans le champ "nom_genre_delete_wtf" du formulaire "genres/personne_delete_wtf.html",
    ...
    try:
        ...
        if request.method == "POST" and form_delete.validate_on_submit():
            ...
            if form_delete.submit_btn_del.data:
                ...
                str_sql_delete_films_genre = """DELETE FROM t_pers_depense_reel_categorie WHERE fk_categorie = %(value_id_genre)s"""
                str_sql_delete_idgenre = """DELETE FROM t_categorie WHERE id_categorie = %(value_id_genre)s"""
        ...
        if request.method == "GET":
            ...
            # Requête qui affiche toutes les dépenses qui ont la categorie que l'utilisateur veut effacer
            str_sql_genres_films_delete = """SELECT id_pers_dep_reel_cat, montant_reel, id_categorie, nom_categorie FROM t_pers_depense_reel_categorie 
                                            INNER JOIN t_categorie ON t_pers_depense_reel_categorie.fk_categorie = t_categorie.id_categorie
                                            WHERE fk_categorie = %(value_id_genre)s"""
            ...
            with DBconnection() as mydb_conn:
                ...
                # Opération sur la BD pour récupérer "id_genre" et "intitule_genre" de la "t_genre"
                str_sql_id_genre = "SELECT id_categorie, nom_categorie FROM t_categorie WHERE id_categorie = %(value_id_genre)s"
